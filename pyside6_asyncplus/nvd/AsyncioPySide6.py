...
from .performance import get_health_status, record_task_completion, record_task_start

logger = logging.getLogger(__name__)


def suppress_coroutine_warnings() -> None:
...
class AsyncioPySide6:
    ...
    def __new__(cls) -> "AsyncioPySide6":
    ...
    def __enter__(self) -> "AsyncioPySide6":
    ...
    def _internal_exit(
        self, exc_type: Optional[type] = None, exc_value: Optional[Exception] = None, traceback: Optional[Any] = None
    ) -> None:
    ...
    def _internal_shutdown(self, timeout: Optional[float] = None) -> bool:
    ...
    def _handle_enhanced_task_completion(self, future: Any) -> None:
    ...
    def _handle_task_completion(self, task_id: str, future: Any) -> None:
    ...
    @staticmethod
    def use_asyncio(use_dedicated_thread: Optional[bool] = None) -> "AsyncioPySide6":
    ...
    @staticmethod
    def initialize(use_dedicated_thread: Optional[bool] = None) -> None:
    ...
    @staticmethod
    def shutdown(timeout: Optional[float] = None) -> bool:
    ...
    @staticmethod
    def runTaskWithTimeout(coro: Coroutine[Any, Any, Any], timeout: Optional[float] = None) -> None:
    ...
    @staticmethod
    def runTaskWithProgress(coro: Coroutine[Any, Any, Any], progress_callback: Callable[[float], None]) -> None:
        ...
        def safe_progress_callback(progress: float) -> None:
        ...
        async def progress_wrapper() -> Any:
            try:
