...
class TestPerformanceMonitoring:
    ...
    def test_record_task_completion_with_error(self):
    ...
    def test_health_status_with_tasks(self):
    ...
    def test_metrics_cleanup(self):
        ...
        monitor._metrics.append(PerformanceMetrics(
...
class TestPerformanceIntegration:
    ...
    def test_performance_monitoring_with_tasks(self):
